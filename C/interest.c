...
int main(){
	...
	printf("Input number of years of loan: ");
	scanf("%d",&duration);
	...
	//
	printf("Your total payable interest is %f when principal_amount given as %f, duration is %d years\n", total_interest, principal_amount, duration);
